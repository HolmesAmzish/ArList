      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-dark-bg-secondary rounded-2xl shadow-xl dark:shadow-slate-900/50 p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-800 dark:text-dark-text-primary">Create Account</h1>
            <p className="text-slate-500 dark:text-dark-text-secondary mt-2">Join us and start organizing your tasks</p>
          </div>
